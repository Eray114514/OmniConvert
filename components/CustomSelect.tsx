  ...
  return (
    <div className={cn("relative", className)} ref={containerRef}>
      <button
        ...
        className={cn(
          "w-full flex items-center justify-between bg-white/50 dark:bg-dark-card/50 backdrop-blur-sm border border-slate-200 dark:border-gray-700 text-slate-700 dark:text-gray-200 text-sm rounded-lg p-2.5 outline-none transition-all shadow-sm hover:shadow-md hover:bg-white/80 dark:hover:bg-dark-card/80",
          disabled ? "opacity-50 cursor-not-allowed" : "cursor-pointer hover:border-primary-400 dark:hover:border-primary-500",
          isOpen && "border-primary-500 ring-2 ring-primary-500/20 dark:ring-primary-500/30 shadow-primary-500/10 bg-white/90 dark:bg-dark-card/90"
        )}
      >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    value === option.value
                      ...
                      : "text-slate-600 dark:text-gray-300 hover:bg-slate-100/80 dark:hover:bg-gray-800/80 hover:text-slate-900 dark:hover:text-white"
                  )}
                >
