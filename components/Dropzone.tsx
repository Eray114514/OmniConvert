    ...
    <div
      ...
      className={`
        ...
        ${isDragging 
          ...
          : 'border-dark-border bg-dark-card hover:border-primary-500/50 hover:bg-dark-card/80'
        }
      `}
    >
      <input
      ...
      <div className={`p-4 rounded-full bg-primary-500/20 text-primary-400 transition-transform duration-300 ${isDragging ? 'scale-110' : 'group-hover:scale-110'}`}>
