  ...
  return (
    <header className="py-8 text-center relative z-10">
      <div className="inline-flex items-center justify-center gap-3 mb-4">
        ...
        <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white via-primary-100 to-primary-300 tracking-tight">
          OmniConverter
        </h1>
      </div>
      <p className="text-gray-400 max-w-lg mx-auto text-lg flex items-center justify-center gap-2">
